...
import { create } from '../../stores/billings/billingsSlice';
...
BillingsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_BILLINGS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default BillingsNew;
