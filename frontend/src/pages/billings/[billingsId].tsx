...
const EditBillings = () => {
  ...
  const { billingsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: billingsId }));
  }, [billingsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: billingsId, data }));
...
EditBillings.getLayout = function getLayout(page: ReactElement) {
  return (
