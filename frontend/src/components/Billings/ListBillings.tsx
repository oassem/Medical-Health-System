...
const ListBillings = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_BILLINGS');
        ...
        {!loading &&
          billings.map((item) => (
            ...
            >
              ...
              >
                <Link
                  href={`/billings/billings-view/?id=${item.id}`}
                  className={
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>BillingDate</p>
                    <p className={'line-clamp-2'}>
                ...
                <ListActionsPopover
                  onDelete={onDelete}
                  itemId={item.id}
                  pathEdit={`/billings/billings-edit/?id=${item.id}`}
                  pathView={`/billings/billings-view/?id=${item.id}`}
