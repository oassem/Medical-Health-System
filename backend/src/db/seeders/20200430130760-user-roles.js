...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_BILLINGS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_BILLINGS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_BILLINGS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_BILLINGS'),
      },

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_DOCTORS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_DOCTORS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_DOCTORS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_DOCTORS'),
      },
